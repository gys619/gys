...
function invite() {
  var headers = {
    'Host': 'inviter.imdada.cn',
    'uuid': 'uid',
    'Accept': 'application/json, text/plain, */*',
    'appName': 'appName',
    'Verification-Hash': 'monitorYou',
    'Accept-Language': 'zh-cn',
    'Content-Type': 'application/json;charset=UTF-8',
    'Origin': 'https://fe.imdada.cn',
    'User-Agent': 'Mozilla/5.0 (iPad; CPU OS 14_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.2(0x18000237) NetType/WIFI Language/zh_CN miniProgram',
    'Referer': 'https://fe.imdada.cn/dj_landing/bamboo/share_get_coupon/index.html?taskId=207572&inviterId=5148547&djPin=JD_20a40c4e5f461d4&channel=fxfx&channelId=homepage_label3&buttonType=1&mpLogOut=false&lat=32.038776&lgt=118.78537&lng=118.78537&cityId=904&openId=oRXXq0CMB9eajKt9ZCTrIWWLCVw4&_is_djxcx_=1',
    'User-Token': '1'
  };

  var dataString = `{"inviterId":"5148547","phone":"${$.phone}","shopId":"0","taskId":"207572","longitude":"","latitude":""}`;

  var options = {
    url: 'https://inviter.imdada.cn/v1/coupon/shareReceiveCoupon',
    headers: headers,
    body: dataString
  };
  return new Promise(resolve => {
...
function joinTuan(groupId=106650066000052,activityId="22c8658cb51314a") {
  let body = {"encryptData":"Uxeju8RJ9VAd4XMztwo9EzQeBLsbVofnRcoiqr+mUK8PPCLq3HKZViaE69ZJJ+aMEfnGnEXXvaTbqNlBFMcxAxABMPWKI9KI1KUMj3Lhhv19+NiqKcLc0EKUzF9QUCz8R7n9X95BdrBOjEB+kjik2KVnoMTzoB9IhW7nHDCpbxc=","groupId":"106650066000052","activityId":"22c8658cb51314a","nickName":"Arcturus","nickHeadUrl":"https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJOg5lyCO6QAcaK8F3c1PibOIyX6ezzDWdVKKicMyFyQkAZPIQicGUWp97CBMPaZnDoxTBzBqJFf8f0A/132","wcUnionId":"","formId":"","type":1,"traceId":"2021-03-18T15:15:53.448Z"}
  return new Promise(resolve => {
