...
[task_local]
#jd免费水果
5 0,6-18/6 * * * jd_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 0,6-18/6 * * *" script-path=jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 0,6-18/6 * * *",wake-system=1,timeout=3600,script-path=jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=jd_fruit.js, cronexpr="5 0,6-18/6 * * *", timeout=3600, enable=true
...
let jdNotifyyy = true;//是否关闭通知，false打开通知推送，true关闭通知推送
